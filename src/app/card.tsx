interface CardProps {
  ...
  export default function Card({ date, maxTemp, minTemp, avgTemp }: CardProps) {
    return (
      <a href="#" className="block p-4 bg-white border border-gray-200 rounded-lg shadow max-w-xs mx-1 transition-transform transform hover:rotate-3d duration-300">
